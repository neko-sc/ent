...
func (b *UserUpdate) check() error {
	...
	if b.mutation.patch.Email.IsNull() {
		return &ValidationError{Name: "email", err: errors.New(`ent: field "User.email" is not nullable`)}
	}
	...
	if b.mutation.patch.Tags.IsNull() {
		return &ValidationError{Name: "tags", err: errors.New(`ent: field "User.tags" is not nullable`)}
	}

	if b.mutation.patch.Profile.IsNull() {
		return &ValidationError{Name: "profile", err: errors.New(`ent: field "User.profile" is not nullable`)}
	}
...
func (_u *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`testschema: missing "User.id" for update`)}
	}
