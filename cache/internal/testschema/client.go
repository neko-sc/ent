...
var ErrTxStarted = errors.New("testschema: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("testschema: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (any, error) {
	...
	default:
		return nil, fmt.Errorf("testschema: unknown mutation type %T", m)
	}
}
...
func (c *GroupClient) mutate(ctx context.Context, m *GroupMutation) (any, error) {
	...
	default:
		return nil, fmt.Errorf("testschema: unknown Group mutation op: %q", m.Op())
	}
}
...
func (c *PetClient) mutate(ctx context.Context, m *PetMutation) (any, error) {
	...
	default:
		return nil, fmt.Errorf("testschema: unknown Pet mutation op: %q", m.Op())
	}
}
...
func (c *UserClient) mutate(ctx context.Context, m *UserMutation) (any, error) {
	...
	default:
		return nil, fmt.Errorf("testschema: unknown User mutation op: %q", m.Op())
	}
}
