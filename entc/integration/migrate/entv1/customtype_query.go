...
// CustomType, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *CustomTypeQuery) WithCount[N, K any](edge ent.Relation[entity.CustomType, N, K], predicates ...ent.Predicate[N]) *CustomTypeQuery {
...
// always included.
func (_q *CustomTypeQuery) Columns(columns ...ent.EntityColumn[entity.CustomType]) *CustomTypeQuery {
	if len(columns) == 0 {
