...
func (_d *ZooDelete) Where(predicates ...ent.Predicate[entity.Zoo]) *ZooDelete {
...
func (b *ZooDelete) Returning(ctx context.Context) ([]*Zoo, error) {
	nodes := make([]*Zoo, 0)
...
// Where appends a list predicates to the ZooDelete builder.
func (_d *ZooDeleteOne) Where(predicates ...ent.Predicate[entity.Zoo]) *ZooDeleteOne {
