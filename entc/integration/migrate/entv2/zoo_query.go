...
type ZooQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.Zoo]
...
func (_q *ZooQuery) Where(predicates ...ent.Predicate[entity.Zoo]) *ZooQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *ZooQuery) WhereP(predicates ...func(*sql.Selector)) *ZooQuery {
...
func (_q *ZooQuery) Join(table string, on ...func(*sql.Selector)) *ZooQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *ZooQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *ZooQuery {
...
func (_q *ZooQuery) LeftJoin(table string, on ...func(*sql.Selector)) *ZooQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *ZooQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *ZooQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// Zoo, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *ZooQuery) WithCount[N, K any](edge ent.Relation[entity.Zoo, N, K], predicates ...ent.Predicate[N]) *ZooQuery {
...
func (_q *ZooQuery) Order(o ...ent.OrderOption[entity.Zoo]) *ZooQuery {
...
// always included.
func (_q *ZooQuery) Columns(columns ...ent.EntityColumn[entity.Zoo]) *ZooQuery {
	if len(columns) == 0 {
...
func (_q *ZooQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(zoo.ID), zoo.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *ZooQuery) Clone() *ZooQuery {
	...
	cloned := &ZooQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.Zoo]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.Zoo]{}, _q.predicates...),
...
func (_q *ZooQuery) GroupBy(columns ...ent.EntityColumn[entity.Zoo]) *ZooGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &ZooGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.Zoo](nil), columns...)}
}

// Select allows the selection one or more fields/columns for the given query,
// instead of selecting all fields in the entity.
func (_q *ZooQuery) Select(selections ...ent.Selection) *ZooSelect {
	return &ZooSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a ZooSelect configured with the given aggregations.
func (_q *ZooQuery) Aggregate(selections ...ent.Selection) *ZooSelect {
...
func (_q *ZooQuery) ForUpdate(opts ...sql.LockOption) *ZooQuery {
...
func (_q *ZooQuery) ForShare(opts ...sql.LockOption) *ZooQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
type ZooGroupBy struct {
	query      *ZooQuery
	columns    []ent.EntityColumn[entity.Zoo]
	aggregates []ent.Selection
}

func (_g *ZooGroupBy) Aggregate(selections ...ent.Selection) *ZooGroupBy {
...
func (_g *ZooGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *ZooGroupBy) selectQuery() *ZooSelect {
...
type ZooSelect struct {
	...
	groups     []ent.EntityColumn[entity.Zoo]
}

func (_s *ZooSelect) Aggregate(selections ...ent.Selection) *ZooSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *ZooSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *ZooSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == zoo.Table) {
...
func (_s *ZooSelect) Scan(ctx context.Context, value any) error {
...
func (_s *ZooSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
...
func (_s *ZooSelect) Modify(modifiers ...func(s *sql.Selector)) *ZooSelect {
