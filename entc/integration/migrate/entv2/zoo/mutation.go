...
// Mutation represents an operation that mutates the Zoo nodes in the graph.
...
// NewMutation creates a new Mutation for the Zoo entity.
...
func (m *Mutation) Predicates() []predicate.Zoo {
	return m.predicates
}

// Where appends a list predicates to the Mutation builder.
func (m *Mutation) Where(ps ...predicate.Zoo) {
