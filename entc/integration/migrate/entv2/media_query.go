...
// Media, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *MediaQuery) WithCount[N, K any](edge ent.Relation[entity.Media, N, K], predicates ...ent.Predicate[N]) *MediaQuery {
...
// always included.
func (_q *MediaQuery) Columns(columns ...ent.EntityColumn[entity.Media]) *MediaQuery {
	if len(columns) == 0 {
