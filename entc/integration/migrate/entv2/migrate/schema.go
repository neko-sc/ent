...
var (
	...
	CustomTypesColumns = []*schema.Column{
		...
		{Name: "tz0", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz(0)"}},
		{Name: "tz3", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz(3)"}},
	}
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "default_exprs", Type: field.TypeString, Nullable: true, Default: map[string]schema.Expr{"postgres": "md5('ent')", "sqlite3": "hex('ent')"}},
	...
	ZoosColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true, Default: map[string]schema.Expr{"postgres": "floor(random() * ~(1<<31))", "sqlite3": "abs(random())"}},
	}
