...
// Blog, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *BlogQuery) WithCount[N, K any](edge ent.Relation[entity.Blog, N, K], predicates ...ent.Predicate[N]) *BlogQuery {
...
func (_q *BlogQuery) Modify(modifiers ...func(s *sql.Selector)) *BlogQuery {
