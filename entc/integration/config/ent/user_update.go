...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.patch.DisplayLabel.Get(); ok {
		_spec.SetField(user.FieldDisplayLabel, field.TypeString, value)
	}
	if _u.mutation.patch.DisplayLabel.IsNull() {
		_spec.ClearField(user.FieldDisplayLabel, field.TypeString)
	}
