...
func (m *Mutation) ClearPosts() {
	m.clearedposts = true
}

// PostsCleared reports if the "posts" edge to the Post entity was cleared.
func (m *Mutation) PostsCleared() bool {
...
func (m *Mutation) RemovedPostsIDs() (ids []int) {
...
func (m *Mutation) PostsIDs() (ids []int) {
