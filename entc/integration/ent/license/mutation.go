...
// Mutation represents an operation that mutates the License nodes in the graph.
...
// NewMutation creates a new Mutation for the License entity.
...
func (m *Mutation) Predicates() []predicate.License {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.License) {
