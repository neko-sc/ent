...
// Mutation represents an operation that mutates the Goods nodes in the graph.
...
// NewMutation creates a new Mutation for the Goods entity.
...
func (m *Mutation) Predicates() []predicate.Goods {
	return m.predicates
}

// Where appends a list predicates to the Mutation builder.
func (m *Mutation) Where(ps ...predicate.Goods) {
