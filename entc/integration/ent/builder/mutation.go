...
// Mutation represents an operation that mutates the Builder nodes in the graph.
...
// NewMutation creates a new Mutation for the Builder entity.
...
func (m *Mutation) Predicates() []predicate.Builder {
	return m.predicates
}

// Where appends a list predicates to the Mutation builder.
func (m *Mutation) Where(ps ...predicate.Builder) {
