...
func (_d *GoodsDelete) Where(predicates ...ent.Predicate[entity.Goods]) *GoodsDelete {
...
func (b *GoodsDelete) Returning(ctx context.Context) ([]*Goods, error) {
	nodes := make([]*Goods, 0)
...
// Where appends a list predicates to the GoodsDelete builder.
func (_d *GoodsDeleteOne) Where(predicates ...ent.Predicate[entity.Goods]) *GoodsDeleteOne {
