...
var (
	...
	FieldTypesColumns = []*schema.Column{
		...
		{Name: "datetime", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "date"}},
		{Name: "decimal", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric"}},
		{Name: "link_other", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "varchar", "sqlite3": "varchar(255)"}},
		{Name: "link_other_func", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "varchar", "sqlite3": "varchar(255)"}},
		{Name: "mac", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "macaddr"}},
		{Name: "string_array", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "text[]", "sqlite3": "json"}},
		...
		{Name: "password_other", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "varchar", "sqlite3": "char(32)"}},
