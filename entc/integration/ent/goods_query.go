...
// Goods, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *GoodsQuery) WithCount[N, K any](edge ent.Relation[entity.Goods, N, K], predicates ...ent.Predicate[N]) *GoodsQuery {
...
// always included.
func (_q *GoodsQuery) Columns(columns ...ent.EntityColumn[entity.Goods]) *GoodsQuery {
	if len(columns) == 0 {
...
func (_q *GoodsQuery) Modify(modifiers ...func(s *sql.Selector)) *GoodsQuery {
