...
func (e GroupInfoEdges) Loaded[N, K any](edge ent.RelationOf[entity.GroupInfo, N, K]) bool {
...
func (e *GroupInfoEdges) SetLoaded[N, K any](edge ent.RelationOf[entity.GroupInfo, N, K], loaded bool) {
	switch edge.Ref().Name {
	case "groups":
...
func (e GroupInfoEdges) Count[N, K any](edge ent.Relation[entity.GroupInfo, N, K]) (int, bool) {
