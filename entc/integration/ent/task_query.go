...
type TaskQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.Task]
...
func (_q *TaskQuery) Where(predicates ...ent.Predicate[entity.Task]) *TaskQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *TaskQuery) WhereP(predicates ...func(*sql.Selector)) *TaskQuery {
...
func (_q *TaskQuery) Join(table string, on ...func(*sql.Selector)) *TaskQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *TaskQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *TaskQuery {
...
func (_q *TaskQuery) LeftJoin(table string, on ...func(*sql.Selector)) *TaskQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *TaskQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *TaskQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// Task, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *TaskQuery) WithCount[N, K any](edge ent.Relation[entity.Task, N, K], predicates ...ent.Predicate[N]) *TaskQuery {
...
func (_q *TaskQuery) Order(o ...ent.OrderOption[entity.Task]) *TaskQuery {
...
// always included.
func (_q *TaskQuery) Columns(columns ...ent.EntityColumn[entity.Task]) *TaskQuery {
	if len(columns) == 0 {
...
func (_q *TaskQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(task.ID), task.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *TaskQuery) Clone() *TaskQuery {
	...
	cloned := &TaskQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.Task]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.Task]{}, _q.predicates...),
...
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *TaskQuery) GroupBy(columns ...ent.EntityColumn[entity.Task]) *TaskGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &TaskGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.Task](nil), columns...)}
}
...
//		Scan(ctx, &v)
func (_q *TaskQuery) Select(selections ...ent.Selection) *TaskSelect {
	return &TaskSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a TaskSelect configured with the given aggregations.
func (_q *TaskQuery) Aggregate(selections ...ent.Selection) *TaskSelect {
...
func (_q *TaskQuery) Modify(modifiers ...func(s *sql.Selector)) *TaskQuery {
...
type TaskGroupBy struct {
	query      *TaskQuery
	columns    []ent.EntityColumn[entity.Task]
	aggregates []ent.Selection
}

func (_g *TaskGroupBy) Aggregate(selections ...ent.Selection) *TaskGroupBy {
...
func (_g *TaskGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *TaskGroupBy) selectQuery() *TaskSelect {
...
type TaskSelect struct {
	...
	groups     []ent.EntityColumn[entity.Task]
}

func (_s *TaskSelect) Aggregate(selections ...ent.Selection) *TaskSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *TaskSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *TaskSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == task.Table) {
...
func (_s *TaskSelect) Scan(ctx context.Context, value any) error {
...
func (_s *TaskSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
