...
type Mutation struct {
	...
	addpriority     *task2.Priority
	priorities      *map[string]task2.Priority
...
func (m *Mutation) SetPriority(t task2.Priority) {
	m.priority = &t
	m.addpriority = nil
}

// Priority returns the value of the "priority" field in the mutation.
func (m *Mutation) Priority() (r task2.Priority, exists bool) {
	v := m.priority
	if v == nil {
		return
	}
...
func (m *Mutation) AddPriority(t task2.Priority) {
...
func (m *Mutation) AddedPriority() (r task2.Priority, exists bool) {
	v := m.addpriority
	if v == nil {
		return
	}
...
func (m *Mutation) SetPriorities(value map[string]task2.Priority) {
	m.priorities = &value
}

// Priorities returns the value of the "priorities" field in the mutation.
func (m *Mutation) Priorities() (r map[string]task2.Priority, exists bool) {
	v := m.priorities
	if v == nil {
		return
	}
