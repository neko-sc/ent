...
func Priority(v task2.Priority) predicate.Task {
	vc := int(v)
...
func PriorityEQ(v task2.Priority) predicate.Task {
	vc := int(v)
	return predicate.Task(sql.FieldEQ(FieldPriority, vc))
}

// PriorityNEQ applies the NEQ predicate on the "priority" field.
func PriorityNEQ(v task2.Priority) predicate.Task {
	vc := int(v)
	return predicate.Task(sql.FieldNEQ(FieldPriority, vc))
}

// PriorityIn applies the In predicate on the "priority" field.
func PriorityIn(vs ...task2.Priority) predicate.Task {
	v := make([]int, len(vs))
	for i := range v {
		v[i] = int(vs[i])
	}
...
func PriorityNotIn(vs ...task2.Priority) predicate.Task {
	v := make([]int, len(vs))
	for i := range v {
		v[i] = int(vs[i])
	}
...
func PriorityGT(v task2.Priority) predicate.Task {
	vc := int(v)
	return predicate.Task(sql.FieldGT(FieldPriority, vc))
}

// PriorityGTE applies the GTE predicate on the "priority" field.
func PriorityGTE(v task2.Priority) predicate.Task {
	vc := int(v)
	return predicate.Task(sql.FieldGTE(FieldPriority, vc))
}

// PriorityLT applies the LT predicate on the "priority" field.
func PriorityLT(v task2.Priority) predicate.Task {
	vc := int(v)
	return predicate.Task(sql.FieldLT(FieldPriority, vc))
}

// PriorityLTE applies the LTE predicate on the "priority" field.
func PriorityLTE(v task2.Priority) predicate.Task {
	vc := int(v)
