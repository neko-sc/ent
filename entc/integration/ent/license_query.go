...
func (_q *LicenseQuery) Where(predicates ...ent.Predicate[entity.License]) *LicenseQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *LicenseQuery) WhereP(predicates ...func(*sql.Selector)) *LicenseQuery {
...
func (_q *LicenseQuery) Join(table string, on ...func(*sql.Selector)) *LicenseQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *LicenseQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *LicenseQuery {
...
func (_q *LicenseQuery) LeftJoin(table string, on ...func(*sql.Selector)) *LicenseQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *LicenseQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *LicenseQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
func (_q *LicenseQuery) Order(o ...ent.OrderOption[entity.License]) *LicenseQuery {
...
// always included.
func (_q *LicenseQuery) Columns(columns ...ent.EntityColumn[entity.License]) *LicenseQuery {
	if len(columns) == 0 {
...
func (_q *LicenseQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(license.ID), license.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
//		GroupBy(license.CreateTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *LicenseQuery) GroupBy(columns ...ent.EntityColumn[entity.License]) *LicenseGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &LicenseGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.License](nil), columns...)}
}
...
//
//	client.License.Query().
//		Select(license.CreateTime).
//		Scan(ctx, &v)
func (_q *LicenseQuery) Select(selections ...ent.Selection) *LicenseSelect {
	return &LicenseSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a LicenseSelect configured with the given aggregations.
func (_q *LicenseQuery) Aggregate(selections ...ent.Selection) *LicenseSelect {
...
type LicenseGroupBy struct {
	query      *LicenseQuery
	columns    []ent.EntityColumn[entity.License]
	aggregates []ent.Selection
}

func (_g *LicenseGroupBy) Aggregate(selections ...ent.Selection) *LicenseGroupBy {
...
func (_g *LicenseGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *LicenseGroupBy) selectQuery() *LicenseSelect {
...
type LicenseSelect struct {
	...
	groups     []ent.EntityColumn[entity.License]
}

func (_s *LicenseSelect) Aggregate(selections ...ent.Selection) *LicenseSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *LicenseSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *LicenseSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == license.Table) {
...
func (_s *LicenseSelect) Scan(ctx context.Context, value any) error {
...
func (_s *LicenseSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
