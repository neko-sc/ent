...
type BuilderQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.Builder]
...
func (_q *BuilderQuery) Where(predicates ...ent.Predicate[entity.Builder]) *BuilderQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *BuilderQuery) WhereP(predicates ...func(*sql.Selector)) *BuilderQuery {
...
func (_q *BuilderQuery) Join(table string, on ...func(*sql.Selector)) *BuilderQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *BuilderQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *BuilderQuery {
...
func (_q *BuilderQuery) LeftJoin(table string, on ...func(*sql.Selector)) *BuilderQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *BuilderQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *BuilderQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// Builder, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *BuilderQuery) WithCount[N, K any](edge ent.Relation[entity.Builder, N, K], predicates ...ent.Predicate[N]) *BuilderQuery {
...
func (_q *BuilderQuery) Order(o ...ent.OrderOption[entity.Builder]) *BuilderQuery {
...
// always included.
func (_q *BuilderQuery) Columns(columns ...ent.EntityColumn[entity.Builder]) *BuilderQuery {
	if len(columns) == 0 {
...
func (_q *BuilderQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(builder.ID), builder.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *BuilderQuery) Clone() *BuilderQuery {
	...
	cloned := &BuilderQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.Builder]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.Builder]{}, _q.predicates...),
...
func (_q *BuilderQuery) GroupBy(columns ...ent.EntityColumn[entity.Builder]) *BuilderGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &BuilderGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.Builder](nil), columns...)}
}

// Select allows the selection one or more fields/columns for the given query,
// instead of selecting all fields in the entity.
func (_q *BuilderQuery) Select(selections ...ent.Selection) *BuilderSelect {
	return &BuilderSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a BuilderSelect configured with the given aggregations.
func (_q *BuilderQuery) Aggregate(selections ...ent.Selection) *BuilderSelect {
...
func (_q *BuilderQuery) Modify(modifiers ...func(s *sql.Selector)) *BuilderQuery {
...
type BuilderGroupBy struct {
	query      *BuilderQuery
	columns    []ent.EntityColumn[entity.Builder]
	aggregates []ent.Selection
}

func (_g *BuilderGroupBy) Aggregate(selections ...ent.Selection) *BuilderGroupBy {
...
func (_g *BuilderGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *BuilderGroupBy) selectQuery() *BuilderSelect {
...
type BuilderSelect struct {
	...
	groups     []ent.EntityColumn[entity.Builder]
}

func (_s *BuilderSelect) Aggregate(selections ...ent.Selection) *BuilderSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *BuilderSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *BuilderSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == builder.Table) {
...
func (_s *BuilderSelect) Scan(ctx context.Context, value any) error {
...
func (_s *BuilderSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
