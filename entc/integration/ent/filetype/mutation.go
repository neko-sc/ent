...
// Mutation represents an operation that mutates the FileType nodes in the graph.
...
// NewMutation creates a new Mutation for the FileType entity.
...
func (m *Mutation) Predicates() []predicate.FileType {
	return m.predicates
}
...
func (m *Mutation) GetType() (r Type, exists bool) {
	v := m._type
	if v == nil {
		return
	}
...
func (m *Mutation) Where(ps ...predicate.FileType) {
