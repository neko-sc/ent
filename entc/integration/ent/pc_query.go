...
type PCQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.PC]
...
func (_q *PCQuery) Where(predicates ...ent.Predicate[entity.PC]) *PCQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *PCQuery) WhereP(predicates ...func(*sql.Selector)) *PCQuery {
...
func (_q *PCQuery) Join(table string, on ...func(*sql.Selector)) *PCQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *PCQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *PCQuery {
...
func (_q *PCQuery) LeftJoin(table string, on ...func(*sql.Selector)) *PCQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *PCQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *PCQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// PC, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *PCQuery) WithCount[N, K any](edge ent.Relation[entity.PC, N, K], predicates ...ent.Predicate[N]) *PCQuery {
...
func (_q *PCQuery) Order(o ...ent.OrderOption[entity.PC]) *PCQuery {
...
// always included.
func (_q *PCQuery) Columns(columns ...ent.EntityColumn[entity.PC]) *PCQuery {
	if len(columns) == 0 {
...
func (_q *PCQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(pc.ID), pc.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *PCQuery) Clone() *PCQuery {
	...
	cloned := &PCQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.PC]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.PC]{}, _q.predicates...),
...
func (_q *PCQuery) GroupBy(columns ...ent.EntityColumn[entity.PC]) *PCGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &PCGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.PC](nil), columns...)}
}

// Select allows the selection one or more fields/columns for the given query,
// instead of selecting all fields in the entity.
func (_q *PCQuery) Select(selections ...ent.Selection) *PCSelect {
	return &PCSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a PCSelect configured with the given aggregations.
func (_q *PCQuery) Aggregate(selections ...ent.Selection) *PCSelect {
...
type PCGroupBy struct {
	query      *PCQuery
	columns    []ent.EntityColumn[entity.PC]
	aggregates []ent.Selection
}

func (_g *PCGroupBy) Aggregate(selections ...ent.Selection) *PCGroupBy {
...
func (_g *PCGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *PCGroupBy) selectQuery() *PCSelect {
...
type PCSelect struct {
	...
	groups     []ent.EntityColumn[entity.PC]
}

func (_s *PCSelect) Aggregate(selections ...ent.Selection) *PCSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *PCSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *PCSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == pc.Table) {
...
func (_s *PCSelect) Scan(ctx context.Context, value any) error {
...
func (_s *PCSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
