...
// Api, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *APIQuery) WithCount[N, K any](edge ent.Relation[entity.Api, N, K], predicates ...ent.Predicate[N]) *APIQuery {
...
func (_q *APIQuery) Modify(modifiers ...func(s *sql.Selector)) *APIQuery {
