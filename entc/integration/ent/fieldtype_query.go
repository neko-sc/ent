...
type FieldTypeQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.FieldType]
...
func (_q *FieldTypeQuery) Where(predicates ...ent.Predicate[entity.FieldType]) *FieldTypeQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *FieldTypeQuery) WhereP(predicates ...func(*sql.Selector)) *FieldTypeQuery {
...
func (_q *FieldTypeQuery) Join(table string, on ...func(*sql.Selector)) *FieldTypeQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *FieldTypeQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *FieldTypeQuery {
...
func (_q *FieldTypeQuery) LeftJoin(table string, on ...func(*sql.Selector)) *FieldTypeQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *FieldTypeQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *FieldTypeQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// FieldType, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *FieldTypeQuery) WithCount[N, K any](edge ent.Relation[entity.FieldType, N, K], predicates ...ent.Predicate[N]) *FieldTypeQuery {
...
func (_q *FieldTypeQuery) Order(o ...ent.OrderOption[entity.FieldType]) *FieldTypeQuery {
...
func (_q *FieldTypeQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(fieldtype.ID), fieldtype.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *FieldTypeQuery) Clone() *FieldTypeQuery {
	...
	cloned := &FieldTypeQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.FieldType]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.FieldType]{}, _q.predicates...),
...
//		GroupBy(fieldtype.Int).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *FieldTypeQuery) GroupBy(columns ...ent.EntityColumn[entity.FieldType]) *FieldTypeGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &FieldTypeGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.FieldType](nil), columns...)}
}
...
//
//	client.FieldType.Query().
//		Select(fieldtype.Int).
//		Scan(ctx, &v)
func (_q *FieldTypeQuery) Select(selections ...ent.Selection) *FieldTypeSelect {
	return &FieldTypeSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a FieldTypeSelect configured with the given aggregations.
func (_q *FieldTypeQuery) Aggregate(selections ...ent.Selection) *FieldTypeSelect {
...
type FieldTypeGroupBy struct {
	...
	columns    []ent.EntityColumn[entity.FieldType]
	aggregates []ent.Selection
}

func (_g *FieldTypeGroupBy) Aggregate(selections ...ent.Selection) *FieldTypeGroupBy {
...
func (_g *FieldTypeGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *FieldTypeGroupBy) selectQuery() *FieldTypeSelect {
...
type FieldTypeSelect struct {
	...
	groups     []ent.EntityColumn[entity.FieldType]
}

func (_s *FieldTypeSelect) Aggregate(selections ...ent.Selection) *FieldTypeSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *FieldTypeSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *FieldTypeSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == fieldtype.Table) {
...
func (_s *FieldTypeSelect) Scan(ctx context.Context, value any) error {
...
func (_s *FieldTypeSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
