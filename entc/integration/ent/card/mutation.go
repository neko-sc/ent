...
func (m *Mutation) SetUpdateTime(t time.Time) {
	m.update_time = &t
}

// UpdateTime returns the value of the "update_time" field in the mutation.
func (m *Mutation) UpdateTime() (r time.Time, exists bool) {
	v := m.update_time
	if v == nil {
		return
	}
...
func (m *Mutation) ResetUpdateTime() {
	m.update_time = nil
}

// SetBalance sets the "balance" field.
func (m *Mutation) SetBalance(f float64) {
	m.balance = &f
	m.addbalance = nil
}

// Balance returns the value of the "balance" field in the mutation.
func (m *Mutation) Balance() (r float64, exists bool) {
	v := m.balance
	if v == nil {
		return
	}
...
func (m *Mutation) AddBalance(f float64) {
	if m.addbalance != nil {
		*m.addbalance += f
	} else {
		m.addbalance = &f
...
func (m *Mutation) AddedBalance() (r float64, exists bool) {
	v := m.addbalance
	if v == nil {
		return
	}
...
func (m *Mutation) Fields() []string {
	...
	if m.update_time != nil {
		fields = append(fields, FieldUpdateTime)
	}
	if m.balance != nil {
		fields = append(fields, FieldBalance)
	}
	if m.number != nil {
