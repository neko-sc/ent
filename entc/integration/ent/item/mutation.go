...
// Mutation represents an operation that mutates the Item nodes in the graph.
...
// NewMutation creates a new Mutation for the Item entity.
...
func (m *Mutation) Predicates() []predicate.Item {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.Item) {
