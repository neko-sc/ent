...
type ItemQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.Item]
...
func (_q *ItemQuery) Where(predicates ...ent.Predicate[entity.Item]) *ItemQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *ItemQuery) WhereP(predicates ...func(*sql.Selector)) *ItemQuery {
...
func (_q *ItemQuery) Join(table string, on ...func(*sql.Selector)) *ItemQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *ItemQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *ItemQuery {
...
func (_q *ItemQuery) LeftJoin(table string, on ...func(*sql.Selector)) *ItemQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *ItemQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *ItemQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// Item, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *ItemQuery) WithCount[N, K any](edge ent.Relation[entity.Item, N, K], predicates ...ent.Predicate[N]) *ItemQuery {
...
func (_q *ItemQuery) Order(o ...ent.OrderOption[entity.Item]) *ItemQuery {
...
// always included.
func (_q *ItemQuery) Columns(columns ...ent.EntityColumn[entity.Item]) *ItemQuery {
	if len(columns) == 0 {
...
func (_q *ItemQuery) IDs(ctx context.Context) (ids []string, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(item.ID), item.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *ItemQuery) Clone() *ItemQuery {
	...
	cloned := &ItemQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.Item]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.Item]{}, _q.predicates...),
...
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *ItemQuery) GroupBy(columns ...ent.EntityColumn[entity.Item]) *ItemGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &ItemGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.Item](nil), columns...)}
}
...
//		Select(item.Text).
//		Scan(ctx, &v)
func (_q *ItemQuery) Select(selections ...ent.Selection) *ItemSelect {
	return &ItemSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a ItemSelect configured with the given aggregations.
func (_q *ItemQuery) Aggregate(selections ...ent.Selection) *ItemSelect {
...
type ItemGroupBy struct {
	query      *ItemQuery
	columns    []ent.EntityColumn[entity.Item]
	aggregates []ent.Selection
}

func (_g *ItemGroupBy) Aggregate(selections ...ent.Selection) *ItemGroupBy {
...
func (_g *ItemGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *ItemGroupBy) selectQuery() *ItemSelect {
...
type ItemSelect struct {
	...
	groups     []ent.EntityColumn[entity.Item]
}

func (_s *ItemSelect) Aggregate(selections ...ent.Selection) *ItemSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *ItemSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *ItemSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == item.Table) {
...
func (_s *ItemSelect) Scan(ctx context.Context, value any) error {
...
func (_s *ItemSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
