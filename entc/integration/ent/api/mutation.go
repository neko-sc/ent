...
// Mutation represents an operation that mutates the Api nodes in the graph.
...
// NewMutation creates a new Mutation for the Api entity.
...
func (m *Mutation) Predicates() []predicate.Api {
	return m.predicates
}

// Where appends a list predicates to the Mutation builder.
func (m *Mutation) Where(ps ...predicate.Api) {
