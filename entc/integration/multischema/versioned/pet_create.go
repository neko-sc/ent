...
func (b *PetCreate) defaults() error {
	...
	if b.mutation.insert.Name.IsUnset() && b.mutation.insert.expressions[pet.FieldName] == nil {

		b.mutation.insert.Name = ent.Some(pet.DefaultName)
	}
...
func (_c *PetCreate) createSpec() (*Pet, *sqlgraph.CreateSpec, error) {
	...
	if _c.mutation.insert.Name.IsNull() {
		_spec.SetField(pet.FieldName, field.TypeString, nil)
	}
