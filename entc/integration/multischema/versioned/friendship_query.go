...
// Friendship, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *FriendshipQuery) WithCount[N, K any](edge ent.Relation[entity.Friendship, N, K], predicates ...ent.Predicate[N]) *FriendshipQuery {
...
// always included.
func (_q *FriendshipQuery) Columns(columns ...ent.EntityColumn[entity.Friendship]) *FriendshipQuery {
	if len(columns) == 0 {
