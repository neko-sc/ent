...
// QueryParentHood chains the current query on the "parent_hood" edge.
func (_q *UserQuery) QueryParentHood() *ParentQuery {
	query := (&ParentClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	cloned := &UserQuery{
		...
		withParentHood:  _q.withParentHood.Clone(),
...
// WithParentHood tells the query-builder to eager-load the nodes that are connected to
// the "parent_hood" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithParentHood(opts ...func(*ParentQuery)) *UserQuery {
	query := (&ParentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withParentHood = query
	return _q
}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withParentHood; query != nil {
		if err := _q.loadParentHood(ctx, query, nodes,
			func(n *User) { n.Edges.ParentHood = []*Parent{} },
			func(n *User, e *Parent) { n.Edges.ParentHood = append(n.Edges.ParentHood, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *UserQuery) loadGroups(ctx context.Context, query *GroupQuery, nodes []*User, init func(*User), assign func(*User, *Group)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			partition := joined.C(user.GroupsPrimaryKey[1])
...
func (_q *UserQuery) loadParents(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			joined, _ := selector.JoinedTable(user.ParentsTable)
			partition := joined.C(user.ParentsPrimaryKey[1])
...
func (_q *UserQuery) loadChildren(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			joined, _ := selector.JoinedTable(user.ChildrenTable)
			partition := joined.C(user.ChildrenPrimaryKey[0])
...
func (_q *UserQuery) loadParentHood(ctx context.Context, query *ParentQuery, nodes []*User, init func(*User), assign func(*User, *Parent)) error {
	query = query.Clone()
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			partition := selector.C(user.ParentHoodColumn)

			(&sqlgraph.NeighborsLimit{RowNumber: "ent_row_number", DefaultOrderField: parent.FieldID, Offset: offset}).Modifier(partition, limit)(selector)
		})
	}
