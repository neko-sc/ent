...
import (
	...
	"github.com/neko-sc/ent/entc/integration/hooks/ent/predicate"
)
...
func (m *Mutation) SetInHook(s string) {
	m.in_hook = &s
}

// InHook returns the value of the "in_hook" field in the mutation.
func (m *Mutation) InHook() (r string, exists bool) {
	v := m.in_hook
	if v == nil {
		return
	}
...
func (m *Mutation) ResetInHook() {
	m.in_hook = nil
}

// SetExpiredAt sets the "expired_at" field.
func (m *Mutation) SetExpiredAt(t time.Time) {
	m.expired_at = &t
}

// ExpiredAt returns the value of the "expired_at" field in the mutation.
func (m *Mutation) ExpiredAt() (r time.Time, exists bool) {
	v := m.expired_at
	if v == nil {
		return
	}
...
func (m *Mutation) ClearExpiredAt() {
	m.expired_at = nil
	m.clearedFields[FieldExpiredAt] = struct{}{}
}

// ExpiredAtCleared returns if the "expired_at" field was cleared in this mutation.
func (m *Mutation) ExpiredAtCleared() bool {
	_, ok := m.clearedFields[FieldExpiredAt]
	return ok
}

// ResetExpiredAt resets all changes to the "expired_at" field.
func (m *Mutation) ResetExpiredAt() {
	m.expired_at = nil
	delete(m.clearedFields, FieldExpiredAt)
}
...
func (m *Mutation) Fields() []string {
	...
	if m.in_hook != nil {
		fields = append(fields, FieldInHook)
	}
	if m.expired_at != nil {
		fields = append(fields, FieldExpiredAt)
	}
	return fields
}
...
func (m *Mutation) ClearedFields() []string {
	...
	if m.FieldCleared(FieldExpiredAt) {
		fields = append(fields, FieldExpiredAt)
	}
	return fields
}
