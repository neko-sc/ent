...
// Mutation represents an operation that mutates the Team nodes in the graph.
...
// NewMutation creates a new Mutation for the Team entity.
...
func (m *Mutation) Predicates() []predicate.Team {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.Team) {
