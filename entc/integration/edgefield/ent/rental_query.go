...
type RentalQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.Rental]
...
func (_q *RentalQuery) Where(predicates ...ent.Predicate[entity.Rental]) *RentalQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *RentalQuery) WhereP(predicates ...func(*sql.Selector)) *RentalQuery {
...
func (_q *RentalQuery) Join(table string, on ...func(*sql.Selector)) *RentalQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *RentalQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *RentalQuery {
...
func (_q *RentalQuery) LeftJoin(table string, on ...func(*sql.Selector)) *RentalQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *RentalQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *RentalQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// Rental, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *RentalQuery) WithCount[N, K any](edge ent.Relation[entity.Rental, N, K], predicates ...ent.Predicate[N]) *RentalQuery {
...
func (_q *RentalQuery) Order(o ...ent.OrderOption[entity.Rental]) *RentalQuery {
...
// always included.
func (_q *RentalQuery) Columns(columns ...ent.EntityColumn[entity.Rental]) *RentalQuery {
	if len(columns) == 0 {
...
func (_q *RentalQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(rental.ID), rental.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *RentalQuery) Clone() *RentalQuery {
	...
	cloned := &RentalQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.Rental]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.Rental]{}, _q.predicates...),
...
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *RentalQuery) GroupBy(columns ...ent.EntityColumn[entity.Rental]) *RentalGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &RentalGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.Rental](nil), columns...)}
}
...
//		Select(rental.Date).
//		Scan(ctx, &v)
func (_q *RentalQuery) Select(selections ...ent.Selection) *RentalSelect {
	return &RentalSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a RentalSelect configured with the given aggregations.
func (_q *RentalQuery) Aggregate(selections ...ent.Selection) *RentalSelect {
...
func (_q *RentalQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Rental, error) {
	...
	if len(_q.withCounts) > 0 {
		...
		parents := make(map[int][]*Rental, len(nodes))
		...
		for _, edge := range _q.withCounts {
			...
			for rows.Next() {
				values, err := (*Rental)(nil).scanValues([]string{rental.FieldID})
				if err != nil {
					rows.Close()
					return nil, err
				}
				...
				decoded := &Rental{}
				if err := decoded.assignValues([]string{rental.FieldID}, values); err != nil {
					rows.Close()
					return nil, err
				}
...
type RentalGroupBy struct {
	query      *RentalQuery
	columns    []ent.EntityColumn[entity.Rental]
	aggregates []ent.Selection
}

func (_g *RentalGroupBy) Aggregate(selections ...ent.Selection) *RentalGroupBy {
...
func (_g *RentalGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *RentalGroupBy) selectQuery() *RentalSelect {
...
type RentalSelect struct {
	...
	groups     []ent.EntityColumn[entity.Rental]
}

func (_s *RentalSelect) Aggregate(selections ...ent.Selection) *RentalSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *RentalSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *RentalSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == rental.Table) {
...
func (_s *RentalSelect) Scan(ctx context.Context, value any) error {
...
func (_s *RentalSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
...
func (_s *RentalSelect) Modify(modifiers ...func(s *sql.Selector)) *RentalSelect {
