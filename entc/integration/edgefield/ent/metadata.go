...
func (e MetadataEdges) Loaded[N, K any](edge ent.RelationOf[entity.Metadata, N, K]) bool {
...
func (e *MetadataEdges) SetLoaded[N, K any](edge ent.RelationOf[entity.Metadata, N, K], loaded bool) {
	switch edge.Ref().Name {
	case "user":
...
func (e MetadataEdges) Count[N, K any](edge ent.Relation[entity.Metadata, N, K]) (int, bool) {
