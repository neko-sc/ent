...
func (b *NodeCreate) SetEdge[N, K any](edge ent.UniqueRelation[entity.Node, N, K], id K) *NodeCreate {
	...
	case node.EdgePrev:
		...
		b.present[node.FieldPrevID] = struct{}{}
...
func (b *NodeCreate) defaults() error {
	...
	if b.mutation.insert.Value.IsUnset() && b.mutation.insert.expressions[node.FieldValue] == nil {

		b.mutation.insert.Value = ent.Some(node.DefaultValue)
	}
...
func (b *NodeCreate) check() error {
	...
	if b.mutation.insert.Value.IsNull() {
