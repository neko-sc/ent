...
func (_q *InfoQuery) Where(predicates ...ent.Predicate[entity.Info]) *InfoQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *InfoQuery) WhereP(predicates ...func(*sql.Selector)) *InfoQuery {
...
func (_q *InfoQuery) Join(table string, on ...func(*sql.Selector)) *InfoQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *InfoQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *InfoQuery {
...
func (_q *InfoQuery) LeftJoin(table string, on ...func(*sql.Selector)) *InfoQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *InfoQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *InfoQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
func (_q *InfoQuery) Order(o ...ent.OrderOption[entity.Info]) *InfoQuery {
...
func (_q *InfoQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(info.ID), info.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
//
//	client.Info.Query().
//		GroupBy(info.Content).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *InfoQuery) GroupBy(columns ...ent.EntityColumn[entity.Info]) *InfoGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &InfoGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.Info](nil), columns...)}
}
...
//		Select(info.Content).
//		Scan(ctx, &v)
func (_q *InfoQuery) Select(selections ...ent.Selection) *InfoSelect {
	return &InfoSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a InfoSelect configured with the given aggregations.
func (_q *InfoQuery) Aggregate(selections ...ent.Selection) *InfoSelect {
...
func (_q *InfoQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Info, error) {
	...
	if len(_q.withCounts) > 0 {
		...
		parents := make(map[int][]*Info, len(nodes))
		...
		for _, edge := range _q.withCounts {
			...
			for rows.Next() {
				values, err := (*Info)(nil).scanValues([]string{info.FieldID})
				if err != nil {
					rows.Close()
					return nil, err
				}
				...
				decoded := &Info{}
				if err := decoded.assignValues([]string{info.FieldID}, values); err != nil {
					rows.Close()
					return nil, err
				}
...
func (_q *InfoQuery) ForUpdate(opts ...sql.LockOption) *InfoQuery {
...
func (_q *InfoQuery) ForShare(opts ...sql.LockOption) *InfoQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
type InfoGroupBy struct {
	query      *InfoQuery
	columns    []ent.EntityColumn[entity.Info]
	aggregates []ent.Selection
}

func (_g *InfoGroupBy) Aggregate(selections ...ent.Selection) *InfoGroupBy {
...
func (_g *InfoGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *InfoGroupBy) selectQuery() *InfoSelect {
...
type InfoSelect struct {
	...
	groups     []ent.EntityColumn[entity.Info]
}

func (_s *InfoSelect) Aggregate(selections ...ent.Selection) *InfoSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *InfoSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *InfoSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == info.Table) {
...
func (_s *InfoSelect) Scan(ctx context.Context, value any) error {
...
func (_s *InfoSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *InfoSelect) Modify(modifiers ...func(s *sql.Selector)) *InfoSelect {
