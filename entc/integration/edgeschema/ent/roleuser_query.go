...
// RoleUser, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *RoleUserQuery) WithCount[N, K any](edge ent.Relation[entity.RoleUser, N, K], predicates ...ent.Predicate[N]) *RoleUserQuery {
...
// always included.
func (_q *RoleUserQuery) Columns(columns ...ent.EntityColumn[entity.RoleUser]) *RoleUserQuery {
	if len(columns) == 0 {
