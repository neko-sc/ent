...
func (_d *AttachedFileDelete) Where(predicates ...ent.Predicate[entity.AttachedFile]) *AttachedFileDelete {
...
func (b *AttachedFileDelete) Returning(ctx context.Context) ([]*AttachedFile, error) {
...
// Where appends a list predicates to the AttachedFileDelete builder.
func (_d *AttachedFileDeleteOne) Where(predicates ...ent.Predicate[entity.AttachedFile]) *AttachedFileDeleteOne {
