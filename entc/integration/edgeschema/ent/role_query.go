...
func (_q *RoleQuery) Where(predicates ...ent.Predicate[entity.Role]) *RoleQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *RoleQuery) WhereP(predicates ...func(*sql.Selector)) *RoleQuery {
...
func (_q *RoleQuery) Join(table string, on ...func(*sql.Selector)) *RoleQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *RoleQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *RoleQuery {
...
func (_q *RoleQuery) LeftJoin(table string, on ...func(*sql.Selector)) *RoleQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *RoleQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *RoleQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
func (_q *RoleQuery) Order(o ...ent.OrderOption[entity.Role]) *RoleQuery {
...
// always included.
func (_q *RoleQuery) Columns(columns ...ent.EntityColumn[entity.Role]) *RoleQuery {
	if len(columns) == 0 {
...
func (_q *RoleQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(role.ID), role.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *RoleQuery) GroupBy(columns ...ent.EntityColumn[entity.Role]) *RoleGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &RoleGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.Role](nil), columns...)}
}
...
//		Select(role.Name).
//		Scan(ctx, &v)
func (_q *RoleQuery) Select(selections ...ent.Selection) *RoleSelect {
	return &RoleSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a RoleSelect configured with the given aggregations.
func (_q *RoleQuery) Aggregate(selections ...ent.Selection) *RoleSelect {
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if len(_q.withCounts) > 0 {
		...
		parents := make(map[int][]*Role, len(nodes))
		...
		for _, edge := range _q.withCounts {
			...
			for rows.Next() {
				values, err := (*Role)(nil).scanValues([]string{role.FieldID})
				if err != nil {
					rows.Close()
					return nil, err
				}
				...
				decoded := &Role{}
				if err := decoded.assignValues([]string{role.FieldID}, values); err != nil {
					rows.Close()
					return nil, err
				}
...
func (_q *RoleQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Role, init func(*Role), assign func(*Role, *User)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			joined, _ := selector.JoinedTable(role.UserTable)
			partition := joined.C(role.UserPrimaryKey[1])
...
func (_q *RoleQuery) loadRolesUsers(ctx context.Context, query *RoleUserQuery, nodes []*Role, init func(*Role), assign func(*Role, *RoleUser)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			partition := selector.C(role.RolesUsersColumn)

			(&sqlgraph.NeighborsLimit{RowNumber: "ent_row_number", DefaultOrderField: roleuser.Columns[0], Offset: offset}).Modifier(partition, limit)(selector)
		})
	}
...
func (_q *RoleQuery) Modify(modifiers ...func(s *sql.Selector)) *RoleQuery {
...
type RoleGroupBy struct {
	query      *RoleQuery
	columns    []ent.EntityColumn[entity.Role]
	aggregates []ent.Selection
}

func (_g *RoleGroupBy) Aggregate(selections ...ent.Selection) *RoleGroupBy {
...
func (_g *RoleGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *RoleGroupBy) selectQuery() *RoleSelect {
...
type RoleSelect struct {
	...
	groups     []ent.EntityColumn[entity.Role]
}

func (_s *RoleSelect) Aggregate(selections ...ent.Selection) *RoleSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *RoleSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *RoleSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == role.Table) {
...
func (_s *RoleSelect) Scan(ctx context.Context, value any) error {
...
func (_s *RoleSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
