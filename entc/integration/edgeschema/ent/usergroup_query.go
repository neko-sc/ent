...
func (_q *UserGroupQuery) Where(predicates ...ent.Predicate[entity.UserGroup]) *UserGroupQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *UserGroupQuery) WhereP(predicates ...func(*sql.Selector)) *UserGroupQuery {
...
func (_q *UserGroupQuery) Join(table string, on ...func(*sql.Selector)) *UserGroupQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *UserGroupQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *UserGroupQuery {
...
func (_q *UserGroupQuery) LeftJoin(table string, on ...func(*sql.Selector)) *UserGroupQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *UserGroupQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *UserGroupQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
func (_q *UserGroupQuery) Order(o ...ent.OrderOption[entity.UserGroup]) *UserGroupQuery {
...
// always included.
func (_q *UserGroupQuery) Columns(columns ...ent.EntityColumn[entity.UserGroup]) *UserGroupQuery {
	if len(columns) == 0 {
...
func (_q *UserGroupQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(usergroup.ID), usergroup.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
//		GroupBy(usergroup.JoinedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *UserGroupQuery) GroupBy(columns ...ent.EntityColumn[entity.UserGroup]) *UserGroupGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &UserGroupGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.UserGroup](nil), columns...)}
}
...
//
//	client.UserGroup.Query().
//		Select(usergroup.JoinedAt).
//		Scan(ctx, &v)
func (_q *UserGroupQuery) Select(selections ...ent.Selection) *UserGroupSelect {
	return &UserGroupSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a UserGroupSelect configured with the given aggregations.
func (_q *UserGroupQuery) Aggregate(selections ...ent.Selection) *UserGroupSelect {
...
func (_q *UserGroupQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserGroup, error) {
	...
	if len(_q.withCounts) > 0 {
		...
		parents := make(map[int][]*UserGroup, len(nodes))
		...
		for _, edge := range _q.withCounts {
			...
			for rows.Next() {
				values, err := (*UserGroup)(nil).scanValues([]string{usergroup.FieldID})
				if err != nil {
					rows.Close()
					return nil, err
				}
				...
				decoded := &UserGroup{}
				if err := decoded.assignValues([]string{usergroup.FieldID}, values); err != nil {
					rows.Close()
					return nil, err
				}
...
func (_q *UserGroupQuery) ForUpdate(opts ...sql.LockOption) *UserGroupQuery {
...
func (_q *UserGroupQuery) ForShare(opts ...sql.LockOption) *UserGroupQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
type UserGroupGroupBy struct {
	...
	columns    []ent.EntityColumn[entity.UserGroup]
	aggregates []ent.Selection
}

func (_g *UserGroupGroupBy) Aggregate(selections ...ent.Selection) *UserGroupGroupBy {
...
func (_g *UserGroupGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *UserGroupGroupBy) selectQuery() *UserGroupSelect {
...
type UserGroupSelect struct {
	...
	groups     []ent.EntityColumn[entity.UserGroup]
}

func (_s *UserGroupSelect) Aggregate(selections ...ent.Selection) *UserGroupSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *UserGroupSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *UserGroupSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == usergroup.Table) {
...
func (_s *UserGroupSelect) Scan(ctx context.Context, value any) error {
...
func (_s *UserGroupSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
