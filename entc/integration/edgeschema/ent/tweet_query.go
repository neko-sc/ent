...
// Tweet, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *TweetQuery) WithCount[N, K any](edge ent.Relation[entity.Tweet, N, K], predicates ...ent.Predicate[N]) *TweetQuery {
...
func (_q *TweetQuery) Modify(modifiers ...func(s *sql.Selector)) *TweetQuery {
