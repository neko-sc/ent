...
// UserTweet, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *UserTweetQuery) WithCount[N, K any](edge ent.Relation[entity.UserTweet, N, K], predicates ...ent.Predicate[N]) *UserTweetQuery {
...
// always included.
func (_q *UserTweetQuery) Columns(columns ...ent.EntityColumn[entity.UserTweet]) *UserTweetQuery {
	if len(columns) == 0 {
...
func (_q *UserTweetQuery) Modify(modifiers ...func(s *sql.Selector)) *UserTweetQuery {
