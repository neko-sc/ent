...
// User, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *UserQuery) WithCount[N, K any](edge ent.Relation[entity.User, N, K], predicates ...ent.Predicate[N]) *UserQuery {
...
func (_q *UserQuery) loadRelatives(ctx context.Context, query *UserQuery, nodes []*User, init func(*User), assign func(*User, *User)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			joined, _ := selector.JoinedTable(user.RelativesTable)
			partition := joined.C(user.RelativesPrimaryKey[0])
...
func (_q *UserQuery) loadLikedTweets(ctx context.Context, query *TweetQuery, nodes []*User, init func(*User), assign func(*User, *Tweet)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			joined, _ := selector.JoinedTable(user.LikedTweetsTable)
			partition := joined.C(user.LikedTweetsPrimaryKey[0])
...
func (_q *UserQuery) loadTweets(ctx context.Context, query *TweetQuery, nodes []*User, init func(*User), assign func(*User, *Tweet)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			joined, _ := selector.JoinedTable(user.TweetsTable)
			partition := joined.C(user.TweetsPrimaryKey[0])
...
func (_q *UserQuery) loadRoles(ctx context.Context, query *RoleQuery, nodes []*User, init func(*User), assign func(*User, *Role)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			joined, _ := selector.JoinedTable(user.RolesTable)
			partition := joined.C(user.RolesPrimaryKey[0])

			(&sqlgraph.NeighborsLimit{RowNumber: "ent_row_number", DefaultOrderField: role.FieldID, Offset: offset}).Modifier(partition, limit)(selector)
		})
	}
	...
	byNeighborID := make(map[int]*Role, len(neighbors))
	for _, neighbor := range neighbors {
		byNeighborID[neighbor.ID] = neighbor
	}
	for parentID, ids := range orderedIDs {
...
func (_q *UserQuery) loadJoinedGroups(ctx context.Context, query *UserGroupQuery, nodes []*User, init func(*User), assign func(*User, *UserGroup)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			partition := selector.C(user.JoinedGroupsColumn)
...
func (_q *UserQuery) loadFriendships(ctx context.Context, query *FriendshipQuery, nodes []*User, init func(*User), assign func(*User, *Friendship)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			partition := selector.C(user.FriendshipsColumn)

			(&sqlgraph.NeighborsLimit{RowNumber: "ent_row_number", DefaultOrderField: friendship.FieldID, Offset: offset}).Modifier(partition, limit)(selector)
		})
	}
...
func (_q *UserQuery) loadRelationship(ctx context.Context, query *RelationshipQuery, nodes []*User, init func(*User), assign func(*User, *Relationship)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			partition := selector.C(user.RelationshipColumn)

			(&sqlgraph.NeighborsLimit{RowNumber: "ent_row_number", DefaultOrderField: relationship.Columns[0], Offset: offset}).Modifier(partition, limit)(selector)
		})
	}
...
func (_q *UserQuery) loadLikes(ctx context.Context, query *TweetLikeQuery, nodes []*User, init func(*User), assign func(*User, *TweetLike)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			partition := selector.C(user.LikesColumn)
...
func (_q *UserQuery) loadUserTweets(ctx context.Context, query *UserTweetQuery, nodes []*User, init func(*User), assign func(*User, *UserTweet)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			partition := selector.C(user.UserTweetsColumn)
...
func (_q *UserQuery) loadRolesUsers(ctx context.Context, query *RoleUserQuery, nodes []*User, init func(*User), assign func(*User, *RoleUser)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			partition := selector.C(user.RolesUsersColumn)
