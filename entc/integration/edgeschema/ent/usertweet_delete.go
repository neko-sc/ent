...
func (_d *UserTweetDelete) Where(predicates ...ent.Predicate[entity.UserTweet]) *UserTweetDelete {
...
func (b *UserTweetDelete) Returning(ctx context.Context) ([]*UserTweet, error) {
...
// Where appends a list predicates to the UserTweetDelete builder.
func (_d *UserTweetDeleteOne) Where(predicates ...ent.Predicate[entity.UserTweet]) *UserTweetDeleteOne {
