...
func (_d *ProcessDelete) Where(predicates ...ent.Predicate[entity.Process]) *ProcessDelete {
...
func (b *ProcessDelete) Returning(ctx context.Context) ([]*Process, error) {
...
// Where appends a list predicates to the ProcessDelete builder.
func (_d *ProcessDeleteOne) Where(predicates ...ent.Predicate[entity.Process]) *ProcessDeleteOne {
