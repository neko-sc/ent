...
func (_q *GroupTagQuery) WithCount[N, K any](edge ent.Relation[entity.GroupTag, N, K]) *GroupTagQuery {
...
func (_q *GroupTagQuery) Modify(modifiers ...func(s *sql.Selector)) *GroupTagSelect {
