...
func (e RelationshipEdges) Loaded[N, K any](edge ent.RelationOf[entity.Relationship, N, K]) bool {
...
func (e *RelationshipEdges) SetLoaded[N, K any](edge ent.RelationOf[entity.Relationship, N, K], loaded bool) {
	switch edge.Ref().Name {
	case "user":
...
func (e RelationshipEdges) Count[N, K any](edge ent.Relation[entity.Relationship, N, K]) (int, bool) {
