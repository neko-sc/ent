...
// Mutation represents an operation that mutates the RelationshipInfo nodes in the graph.
...
// NewMutation creates a new Mutation for the RelationshipInfo entity.
func NewMutation(op ent.Op) *Mutation {
	return &Mutation{
		op:            op,
		typ:           "RelationshipInfo",
		clearedFields: make(map[string]struct{}),
	}
}

// Predicates returns the list of predicates set on the mutation.
func (m *Mutation) Predicates() []predicate.RelationshipInfo {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.RelationshipInfo) {
