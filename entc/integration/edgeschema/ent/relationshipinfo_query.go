...
func (_q *RelationshipInfoQuery) Where(predicates ...ent.Predicate[entity.RelationshipInfo]) *RelationshipInfoQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *RelationshipInfoQuery) WhereP(predicates ...func(*sql.Selector)) *RelationshipInfoQuery {
...
func (_q *RelationshipInfoQuery) Join(table string, on ...func(*sql.Selector)) *RelationshipInfoQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *RelationshipInfoQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *RelationshipInfoQuery {
...
func (_q *RelationshipInfoQuery) LeftJoin(table string, on ...func(*sql.Selector)) *RelationshipInfoQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *RelationshipInfoQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *RelationshipInfoQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
func (_q *RelationshipInfoQuery) Order(o ...ent.OrderOption[entity.RelationshipInfo]) *RelationshipInfoQuery {
...
// always included.
func (_q *RelationshipInfoQuery) Columns(columns ...ent.EntityColumn[entity.RelationshipInfo]) *RelationshipInfoQuery {
	if len(columns) == 0 {
...
func (_q *RelationshipInfoQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(relationshipinfo.ID), relationshipinfo.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
//		GroupBy(relationshipinfo.Text).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *RelationshipInfoQuery) GroupBy(columns ...ent.EntityColumn[entity.RelationshipInfo]) *RelationshipInfoGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &RelationshipInfoGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.RelationshipInfo](nil), columns...)}
}
...
//
//	client.RelationshipInfo.Query().
//		Select(relationshipinfo.Text).
//		Scan(ctx, &v)
func (_q *RelationshipInfoQuery) Select(selections ...ent.Selection) *RelationshipInfoSelect {
	return &RelationshipInfoSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a RelationshipInfoSelect configured with the given aggregations.
func (_q *RelationshipInfoQuery) Aggregate(selections ...ent.Selection) *RelationshipInfoSelect {
...
func (_q *RelationshipInfoQuery) ForUpdate(opts ...sql.LockOption) *RelationshipInfoQuery {
...
func (_q *RelationshipInfoQuery) ForShare(opts ...sql.LockOption) *RelationshipInfoQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *RelationshipInfoQuery) Modify(modifiers ...func(s *sql.Selector)) *RelationshipInfoSelect {
...
type RelationshipInfoGroupBy struct {
	query      *RelationshipInfoQuery
	columns    []ent.EntityColumn[entity.RelationshipInfo]
	aggregates []ent.Selection
}

func (_g *RelationshipInfoGroupBy) Aggregate(selections ...ent.Selection) *RelationshipInfoGroupBy {
...
func (_g *RelationshipInfoGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *RelationshipInfoGroupBy) selectQuery() *RelationshipInfoSelect {
...
type RelationshipInfoSelect struct {
	...
	groups     []ent.EntityColumn[entity.RelationshipInfo]
}

func (_s *RelationshipInfoSelect) Aggregate(selections ...ent.Selection) *RelationshipInfoSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *RelationshipInfoSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *RelationshipInfoSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == relationshipinfo.Table) {
...
func (_s *RelationshipInfoSelect) Scan(ctx context.Context, value any) error {
...
func (_s *RelationshipInfoSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *RelationshipInfoSelect) Modify(modifiers ...func(s *sql.Selector)) *RelationshipInfoSelect {
