...
// Mutation represents an operation that mutates the Process nodes in the graph.
...
// NewMutation creates a new Mutation for the Process entity.
...
func (m *Mutation) Predicates() []predicate.Process {
	return m.predicates
}
...
func (m *Mutation) ClearAttachedFiles() {
...
func (m *Mutation) AttachedFilesCleared() bool {
...
func (m *Mutation) ResetAttachedFiles() {
...
func (m *Mutation) Where(ps ...predicate.Process) {
...
func (m *Mutation) AddedEdges() []string {
	...
	if m.attached_files != nil {
		edges = append(edges, EdgeAttachedFiles)
	}
	return edges
}
