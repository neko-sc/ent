...
// Mutation represents an operation that mutates the TweetLike nodes in the graph.
...
// NewMutation creates a new Mutation for the TweetLike entity.
...
func (m *Mutation) Predicates() []predicate.TweetLike {
	return m.predicates
}

// SetLikedAt sets the "liked_at" field.
func (m *Mutation) SetLikedAt(t time.Time) {
	m.liked_at = &t
}

// LikedAt returns the value of the "liked_at" field in the mutation.
func (m *Mutation) LikedAt() (r time.Time, exists bool) {
	v := m.liked_at
	if v == nil {
		return
	}
...
func (m *Mutation) Where(ps ...predicate.TweetLike) {
...
func (m *Mutation) Fields() []string {
	...
	if m.liked_at != nil {
		fields = append(fields, FieldLikedAt)
	}
	if m.user != nil {
