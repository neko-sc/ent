...
type TweetTagQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.TweetTag]
...
func (_q *TweetTagQuery) Where(predicates ...ent.Predicate[entity.TweetTag]) *TweetTagQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *TweetTagQuery) WhereP(predicates ...func(*sql.Selector)) *TweetTagQuery {
...
func (_q *TweetTagQuery) Join(table string, on ...func(*sql.Selector)) *TweetTagQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *TweetTagQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *TweetTagQuery {
...
func (_q *TweetTagQuery) LeftJoin(table string, on ...func(*sql.Selector)) *TweetTagQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *TweetTagQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *TweetTagQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// TweetTag, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *TweetTagQuery) WithCount[N, K any](edge ent.Relation[entity.TweetTag, N, K], predicates ...ent.Predicate[N]) *TweetTagQuery {
...
func (_q *TweetTagQuery) Order(o ...ent.OrderOption[entity.TweetTag]) *TweetTagQuery {
...
// always included.
func (_q *TweetTagQuery) Columns(columns ...ent.EntityColumn[entity.TweetTag]) *TweetTagQuery {
	if len(columns) == 0 {
...
func (_q *TweetTagQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(tweettag.ID), tweettag.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *TweetTagQuery) Clone() *TweetTagQuery {
	...
	cloned := &TweetTagQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.TweetTag]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.TweetTag]{}, _q.predicates...),
...
//		GroupBy(tweettag.AddedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *TweetTagQuery) GroupBy(columns ...ent.EntityColumn[entity.TweetTag]) *TweetTagGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &TweetTagGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.TweetTag](nil), columns...)}
}
...
//
//	client.TweetTag.Query().
//		Select(tweettag.AddedAt).
//		Scan(ctx, &v)
func (_q *TweetTagQuery) Select(selections ...ent.Selection) *TweetTagSelect {
	return &TweetTagSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a TweetTagSelect configured with the given aggregations.
func (_q *TweetTagQuery) Aggregate(selections ...ent.Selection) *TweetTagSelect {
...
func (_q *TweetTagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*TweetTag, error) {
	...
	if len(_q.withCounts) > 0 {
		...
		parents := make(map[uuid.UUID][]*TweetTag, len(nodes))
		...
		for _, edge := range _q.withCounts {
			...
			for rows.Next() {
				values, err := (*TweetTag)(nil).scanValues([]string{tweettag.FieldID})
				if err != nil {
					rows.Close()
					return nil, err
				}
				...
				decoded := &TweetTag{}
				if err := decoded.assignValues([]string{tweettag.FieldID}, values); err != nil {
					rows.Close()
					return nil, err
				}
...
func (_q *TweetTagQuery) ForUpdate(opts ...sql.LockOption) *TweetTagQuery {
...
func (_q *TweetTagQuery) ForShare(opts ...sql.LockOption) *TweetTagQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
type TweetTagGroupBy struct {
	query      *TweetTagQuery
	columns    []ent.EntityColumn[entity.TweetTag]
	aggregates []ent.Selection
}

func (_g *TweetTagGroupBy) Aggregate(selections ...ent.Selection) *TweetTagGroupBy {
...
func (_g *TweetTagGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *TweetTagGroupBy) selectQuery() *TweetTagSelect {
...
type TweetTagSelect struct {
	...
	groups     []ent.EntityColumn[entity.TweetTag]
}

func (_s *TweetTagSelect) Aggregate(selections ...ent.Selection) *TweetTagSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *TweetTagSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *TweetTagSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == tweettag.Table) {
...
func (_s *TweetTagSelect) Scan(ctx context.Context, value any) error {
...
func (_s *TweetTagSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
...
func (_s *TweetTagSelect) Modify(modifiers ...func(s *sql.Selector)) *TweetTagSelect {
