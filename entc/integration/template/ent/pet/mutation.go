...
import (
	...
	"github.com/neko-sc/ent/entc/integration/template/ent/predicate"
)
...
func (m *Mutation) SetLicensedAt(t time.Time) {
	m.licensed_at = &t
}

// LicensedAt returns the value of the "licensed_at" field in the mutation.
func (m *Mutation) LicensedAt() (r time.Time, exists bool) {
	v := m.licensed_at
	if v == nil {
		return
	}
...
func (m *Mutation) ClearLicensedAt() {
	m.licensed_at = nil
	m.clearedFields[FieldLicensedAt] = struct{}{}
}

// LicensedAtCleared returns if the "licensed_at" field was cleared in this mutation.
func (m *Mutation) LicensedAtCleared() bool {
	_, ok := m.clearedFields[FieldLicensedAt]
	return ok
}

// ResetLicensedAt resets all changes to the "licensed_at" field.
func (m *Mutation) ResetLicensedAt() {
	m.licensed_at = nil
	delete(m.clearedFields, FieldLicensedAt)
}
...
func (m *Mutation) Fields() []string {
	...
	if m.licensed_at != nil {
		fields = append(fields, FieldLicensedAt)
	}
	return fields
}
...
func (m *Mutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(FieldLicensedAt) {
		fields = append(fields, FieldLicensedAt)
	}
	return fields
}
