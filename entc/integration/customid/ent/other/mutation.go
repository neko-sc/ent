...
// Mutation represents an operation that mutates the Other nodes in the graph.
...
// NewMutation creates a new Mutation for the Other entity.
...
func (m *Mutation) Predicates() []predicate.Other {
	return m.predicates
}

// Where appends a list predicates to the Mutation builder.
func (m *Mutation) Where(ps ...predicate.Other) {
