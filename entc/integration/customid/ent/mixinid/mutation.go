...
func (m *Mutation) SetSomeField(s string) {
	m.some_field = &s
}

// SomeField returns the value of the "some_field" field in the mutation.
func (m *Mutation) SomeField() (r string, exists bool) {
	v := m.some_field
	if v == nil {
		return
	}
...
func (m *Mutation) ResetSomeField() {
	m.some_field = nil
}

// SetMixinField sets the "mixin_field" field.
func (m *Mutation) SetMixinField(s string) {
	m.mixin_field = &s
}

// MixinField returns the value of the "mixin_field" field in the mutation.
func (m *Mutation) MixinField() (r string, exists bool) {
	v := m.mixin_field
	if v == nil {
		return
	}
...
func (m *Mutation) ResetMixinField() {
	m.mixin_field = nil
}
...
func (m *Mutation) Fields() []string {
	...
	if m.some_field != nil {
		fields = append(fields, FieldSomeField)
	}
	if m.mixin_field != nil {
		fields = append(fields, FieldMixinField)
	}
	return fields
}
