...
// Device, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *DeviceQuery) WithCount[N, K any](edge ent.Relation[entity.Device, N, K], predicates ...ent.Predicate[N]) *DeviceQuery {
