...
// Token, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *TokenQuery) WithCount[N, K any](edge ent.Relation[entity.Token, N, K], predicates ...ent.Predicate[N]) *TokenQuery {
