...
func (_q *RevisionQuery) WithCount[N, K any](edge ent.Relation[entity.Revision, N, K]) *RevisionQuery {
...
func (_q *RevisionQuery) Modify(modifiers ...func(s *sql.Selector)) *RevisionSelect {
