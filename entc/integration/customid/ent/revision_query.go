...
type RevisionQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.Revision]
...
func (_q *RevisionQuery) Where(predicates ...ent.Predicate[entity.Revision]) *RevisionQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *RevisionQuery) WhereP(predicates ...func(*sql.Selector)) *RevisionQuery {
...
func (_q *RevisionQuery) Join(table string, on ...func(*sql.Selector)) *RevisionQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *RevisionQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *RevisionQuery {
...
func (_q *RevisionQuery) LeftJoin(table string, on ...func(*sql.Selector)) *RevisionQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *RevisionQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *RevisionQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// Revision, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *RevisionQuery) WithCount[N, K any](edge ent.Relation[entity.Revision, N, K], predicates ...ent.Predicate[N]) *RevisionQuery {
...
func (_q *RevisionQuery) Order(o ...ent.OrderOption[entity.Revision]) *RevisionQuery {
...
// always included.
func (_q *RevisionQuery) Columns(columns ...ent.EntityColumn[entity.Revision]) *RevisionQuery {
	if len(columns) == 0 {
...
func (_q *RevisionQuery) IDs(ctx context.Context) (ids []string, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(revision.ID), revision.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *RevisionQuery) Clone() *RevisionQuery {
	...
	cloned := &RevisionQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.Revision]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.Revision]{}, _q.predicates...),
...
func (_q *RevisionQuery) GroupBy(columns ...ent.EntityColumn[entity.Revision]) *RevisionGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &RevisionGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.Revision](nil), columns...)}
}

// Select allows the selection one or more fields/columns for the given query,
// instead of selecting all fields in the entity.
func (_q *RevisionQuery) Select(selections ...ent.Selection) *RevisionSelect {
	return &RevisionSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a RevisionSelect configured with the given aggregations.
func (_q *RevisionQuery) Aggregate(selections ...ent.Selection) *RevisionSelect {
...
func (_q *RevisionQuery) ForUpdate(opts ...sql.LockOption) *RevisionQuery {
...
func (_q *RevisionQuery) ForShare(opts ...sql.LockOption) *RevisionQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *RevisionQuery) Modify(modifiers ...func(s *sql.Selector)) *RevisionQuery {
...
type RevisionGroupBy struct {
	query      *RevisionQuery
	columns    []ent.EntityColumn[entity.Revision]
	aggregates []ent.Selection
}

func (_g *RevisionGroupBy) Aggregate(selections ...ent.Selection) *RevisionGroupBy {
...
func (_g *RevisionGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *RevisionGroupBy) selectQuery() *RevisionSelect {
...
type RevisionSelect struct {
	...
	groups     []ent.EntityColumn[entity.Revision]
}

func (_s *RevisionSelect) Aggregate(selections ...ent.Selection) *RevisionSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *RevisionSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *RevisionSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == revision.Table) {
...
func (_s *RevisionSelect) Scan(ctx context.Context, value any) error {
...
func (_s *RevisionSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
...
func (_s *RevisionSelect) Modify(modifiers ...func(s *sql.Selector)) *RevisionSelect {
