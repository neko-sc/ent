...
func (_q *MixinIDQuery) WithCount[N, K any](edge ent.Relation[entity.MixinID, N, K]) *MixinIDQuery {
...
func (_q *MixinIDQuery) Modify(modifiers ...func(s *sql.Selector)) *MixinIDSelect {
