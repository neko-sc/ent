...
type MixinIDQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.MixinID]
...
func (_q *MixinIDQuery) Where(predicates ...ent.Predicate[entity.MixinID]) *MixinIDQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *MixinIDQuery) WhereP(predicates ...func(*sql.Selector)) *MixinIDQuery {
...
func (_q *MixinIDQuery) Join(table string, on ...func(*sql.Selector)) *MixinIDQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *MixinIDQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *MixinIDQuery {
...
func (_q *MixinIDQuery) LeftJoin(table string, on ...func(*sql.Selector)) *MixinIDQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *MixinIDQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *MixinIDQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// MixinID, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *MixinIDQuery) WithCount[N, K any](edge ent.Relation[entity.MixinID, N, K], predicates ...ent.Predicate[N]) *MixinIDQuery {
...
func (_q *MixinIDQuery) Order(o ...ent.OrderOption[entity.MixinID]) *MixinIDQuery {
...
// always included.
func (_q *MixinIDQuery) Columns(columns ...ent.EntityColumn[entity.MixinID]) *MixinIDQuery {
	if len(columns) == 0 {
...
func (_q *MixinIDQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(mixinid.ID), mixinid.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *MixinIDQuery) Clone() *MixinIDQuery {
	...
	cloned := &MixinIDQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.MixinID]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.MixinID]{}, _q.predicates...),
...
//		GroupBy(mixinid.SomeField).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *MixinIDQuery) GroupBy(columns ...ent.EntityColumn[entity.MixinID]) *MixinIDGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &MixinIDGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.MixinID](nil), columns...)}
}
...
//
//	client.MixinID.Query().
//		Select(mixinid.SomeField).
//		Scan(ctx, &v)
func (_q *MixinIDQuery) Select(selections ...ent.Selection) *MixinIDSelect {
	return &MixinIDSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a MixinIDSelect configured with the given aggregations.
func (_q *MixinIDQuery) Aggregate(selections ...ent.Selection) *MixinIDSelect {
...
func (_q *MixinIDQuery) ForUpdate(opts ...sql.LockOption) *MixinIDQuery {
...
func (_q *MixinIDQuery) ForShare(opts ...sql.LockOption) *MixinIDQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *MixinIDQuery) Modify(modifiers ...func(s *sql.Selector)) *MixinIDQuery {
...
type MixinIDGroupBy struct {
	query      *MixinIDQuery
	columns    []ent.EntityColumn[entity.MixinID]
	aggregates []ent.Selection
}

func (_g *MixinIDGroupBy) Aggregate(selections ...ent.Selection) *MixinIDGroupBy {
...
func (_g *MixinIDGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *MixinIDGroupBy) selectQuery() *MixinIDSelect {
...
type MixinIDSelect struct {
	...
	groups     []ent.EntityColumn[entity.MixinID]
}

func (_s *MixinIDSelect) Aggregate(selections ...ent.Selection) *MixinIDSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *MixinIDSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *MixinIDSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == mixinid.Table) {
...
func (_s *MixinIDSelect) Scan(ctx context.Context, value any) error {
...
func (_s *MixinIDSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
...
func (_s *MixinIDSelect) Modify(modifiers ...func(s *sql.Selector)) *MixinIDSelect {
