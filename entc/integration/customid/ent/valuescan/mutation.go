...
// Mutation represents an operation that mutates the ValueScan nodes in the graph.
...
// NewMutation creates a new Mutation for the ValueScan entity.
...
func (m *Mutation) Predicates() []predicate.ValueScan {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.ValueScan) {
...
func (m *Mutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ValueScan, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Type returns the node type of this mutation (ValueScan).
...
func (m *Mutation) SetField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown ValueScan field %s", name)
}
...
func (m *Mutation) AddField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown ValueScan numeric field %s", name)
}
...
func (m *Mutation) ClearField(name string) error {
	return fmt.Errorf("unknown ValueScan nullable field %s", name)
}
...
func (m *Mutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown ValueScan unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *Mutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown ValueScan edge %s", name)
}
