...
// Account, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *AccountQuery) WithCount[N, K any](edge ent.Relation[entity.Account, N, K], predicates ...ent.Predicate[N]) *AccountQuery {
...
// always included.
func (_q *AccountQuery) Columns(columns ...ent.EntityColumn[entity.Account]) *AccountQuery {
	if len(columns) == 0 {
