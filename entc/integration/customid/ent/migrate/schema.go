...
var (
	...
	AccountsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeOther, SchemaType: map[string]string{"postgres": "bigint", "sqlite3": "integer"}},
	...
	TokensColumns = []*schema.Column{
		...
		{Name: "account_token", Type: field.TypeOther, SchemaType: map[string]string{"postgres": "bigint", "sqlite3": "integer"}},
	}
