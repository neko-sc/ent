...
// always included.
func (_q *PetQuery) Columns(columns ...ent.EntityColumn[entity.Pet]) *PetQuery {
	if len(columns) == 0 {
...
func (_q *PetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Pet, error) {
	...
	if len(_q.withCounts) > 0 {
		...
		parents := make(map[string][]*Pet, len(nodes))
...
func (_q *PetQuery) loadCars(ctx context.Context, query *CarQuery, nodes []*Pet, init func(*Pet), assign func(*Pet, *Car)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			partition := selector.C(pet.CarsColumn)

			(&sqlgraph.NeighborsLimit{RowNumber: "ent_row_number", DefaultOrderField: car.FieldID, Offset: offset}).Modifier(partition, limit)(selector)
		})
	}
...
func (_q *PetQuery) loadFriends(ctx context.Context, query *PetQuery, nodes []*Pet, init func(*Pet), assign func(*Pet, *Pet)) error {
	...
	if query.ctx.Limit != nil || query.ctx.Offset != nil {
		...
		query.modifiers = append(query.modifiers, func(selector *sql.Selector) {
			...
			joined, _ := selector.JoinedTable(pet.FriendsTable)
			partition := joined.C(pet.FriendsPrimaryKey[0])
	...
	orderedIDs := make(map[string][]string)
	...
	neighbors, err := query.sqlAll(ctx, func(_ context.Context, spec *sqlgraph.QuerySpec) {
		...
		spec.ScanValues = func(columns []string) ([]any, error) {
			...
			return append([]any{new(*string)}, values...), nil
		}
