...
// Link, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *LinkQuery) WithCount[N, K any](edge ent.Relation[entity.Link, N, K], predicates ...ent.Predicate[N]) *LinkQuery {
...
// always included.
func (_q *LinkQuery) Columns(columns ...ent.EntityColumn[entity.Link]) *LinkQuery {
	if len(columns) == 0 {
