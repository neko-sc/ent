...
type OtherQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.Other]
...
func (_q *OtherQuery) Where(predicates ...ent.Predicate[entity.Other]) *OtherQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *OtherQuery) WhereP(predicates ...func(*sql.Selector)) *OtherQuery {
...
func (_q *OtherQuery) Join(table string, on ...func(*sql.Selector)) *OtherQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *OtherQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *OtherQuery {
...
func (_q *OtherQuery) LeftJoin(table string, on ...func(*sql.Selector)) *OtherQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *OtherQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *OtherQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// Other, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *OtherQuery) WithCount[N, K any](edge ent.Relation[entity.Other, N, K], predicates ...ent.Predicate[N]) *OtherQuery {
...
func (_q *OtherQuery) Order(o ...ent.OrderOption[entity.Other]) *OtherQuery {
...
// always included.
func (_q *OtherQuery) Columns(columns ...ent.EntityColumn[entity.Other]) *OtherQuery {
	if len(columns) == 0 {
...
func (_q *OtherQuery) IDs(ctx context.Context) (ids []sid.ID, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(other.ID), other.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *OtherQuery) Clone() *OtherQuery {
	...
	cloned := &OtherQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.Other]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.Other]{}, _q.predicates...),
...
func (_q *OtherQuery) GroupBy(columns ...ent.EntityColumn[entity.Other]) *OtherGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &OtherGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.Other](nil), columns...)}
}

// Select allows the selection one or more fields/columns for the given query,
// instead of selecting all fields in the entity.
func (_q *OtherQuery) Select(selections ...ent.Selection) *OtherSelect {
	return &OtherSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a OtherSelect configured with the given aggregations.
func (_q *OtherQuery) Aggregate(selections ...ent.Selection) *OtherSelect {
...
func (_q *OtherQuery) ForUpdate(opts ...sql.LockOption) *OtherQuery {
...
func (_q *OtherQuery) ForShare(opts ...sql.LockOption) *OtherQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
type OtherGroupBy struct {
	query      *OtherQuery
	columns    []ent.EntityColumn[entity.Other]
	aggregates []ent.Selection
}

func (_g *OtherGroupBy) Aggregate(selections ...ent.Selection) *OtherGroupBy {
...
func (_g *OtherGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *OtherGroupBy) selectQuery() *OtherSelect {
...
type OtherSelect struct {
	...
	groups     []ent.EntityColumn[entity.Other]
}

func (_s *OtherSelect) Aggregate(selections ...ent.Selection) *OtherSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *OtherSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *OtherSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == other.Table) {
...
func (_s *OtherSelect) Scan(ctx context.Context, value any) error {
...
func (_s *OtherSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
...
func (_s *OtherSelect) Modify(modifiers ...func(s *sql.Selector)) *OtherSelect {
