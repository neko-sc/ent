...
// Mutation represents an operation that mutates the Revision nodes in the graph.
...
// NewMutation creates a new Mutation for the Revision entity.
...
func (m *Mutation) Predicates() []predicate.Revision {
	return m.predicates
}

// Where appends a list predicates to the Mutation builder.
func (m *Mutation) Where(ps ...predicate.Revision) {
