...
// BlobLink, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *BlobLinkQuery) WithCount[N, K any](edge ent.Relation[entity.BlobLink, N, K], predicates ...ent.Predicate[N]) *BlobLinkQuery {
