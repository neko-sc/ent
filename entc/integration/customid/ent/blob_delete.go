...
func (_d *BlobDelete) Where(predicates ...ent.Predicate[entity.Blob]) *BlobDelete {
...
func (b *BlobDelete) Returning(ctx context.Context) ([]*Blob, error) {
	nodes := make([]*Blob, 0)
...
// Where appends a list predicates to the BlobDelete builder.
func (_d *BlobDeleteOne) Where(predicates ...ent.Predicate[entity.Blob]) *BlobDeleteOne {
