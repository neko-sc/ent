...
type SessionQuery struct {
	config
	ctx        *QueryContext
	order      []ent.OrderOption[entity.Session]
...
func (_q *SessionQuery) Where(predicates ...ent.Predicate[entity.Session]) *SessionQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *SessionQuery) WhereP(predicates ...func(*sql.Selector)) *SessionQuery {
...
func (_q *SessionQuery) Join(table string, on ...func(*sql.Selector)) *SessionQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *SessionQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *SessionQuery {
...
func (_q *SessionQuery) LeftJoin(table string, on ...func(*sql.Selector)) *SessionQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *SessionQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *SessionQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
// Session, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *SessionQuery) WithCount[N, K any](edge ent.Relation[entity.Session, N, K], predicates ...ent.Predicate[N]) *SessionQuery {
...
func (_q *SessionQuery) Order(o ...ent.OrderOption[entity.Session]) *SessionQuery {
...
// always included.
func (_q *SessionQuery) Columns(columns ...ent.EntityColumn[entity.Session]) *SessionQuery {
	if len(columns) == 0 {
...
func (_q *SessionQuery) FirstID(ctx context.Context) (id schema2.ID, err error) {
	var ids []schema2.ID
...
func (_q *SessionQuery) FirstIDX(ctx context.Context) schema2.ID {
...
func (_q *SessionQuery) OnlyID(ctx context.Context) (id schema2.ID, err error) {
	var ids []schema2.ID
...
func (_q *SessionQuery) OnlyIDX(ctx context.Context) schema2.ID {
...
func (_q *SessionQuery) IDs(ctx context.Context) (ids []schema2.ID, err error) {
	if _q.ctx.Unique == nil && _q.path != nil {
		_q.Unique(true)
	}
	if ids, err = ent.Values(ctx, _q.Select(session.ID), session.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *SessionQuery) IDsX(ctx context.Context) []schema2.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SessionQuery) Clone() *SessionQuery {
	...
	cloned := &SessionQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]ent.OrderOption[entity.Session]{}, _q.order...),
		predicates: append([]ent.Predicate[entity.Session]{}, _q.predicates...),
...
func (_q *SessionQuery) GroupBy(columns ...ent.EntityColumn[entity.Session]) *SessionGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &SessionGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.Session](nil), columns...)}
}

// Select allows the selection one or more fields/columns for the given query,
// instead of selecting all fields in the entity.
func (_q *SessionQuery) Select(selections ...ent.Selection) *SessionSelect {
	return &SessionSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a SessionSelect configured with the given aggregations.
func (_q *SessionQuery) Aggregate(selections ...ent.Selection) *SessionSelect {
...
func (_q *SessionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Session, error) {
	...
	if len(_q.withCounts) > 0 {
		...
		parents := make(map[schema2.ID][]*Session, len(nodes))
		...
		for _, edge := range _q.withCounts {
			...
			for rows.Next() {
				values, err := (*Session)(nil).scanValues([]string{session.FieldID})
				if err != nil {
					rows.Close()
					return nil, err
				}
				...
				decoded := &Session{}
				if err := decoded.assignValues([]string{session.FieldID}, values); err != nil {
					rows.Close()
					return nil, err
				}
...
func (_q *SessionQuery) loadDevice(ctx context.Context, query *DeviceQuery, nodes []*Session, init func(*Session), assign func(*Session, *Device)) error {
	...
	nodeids := make(map[schema2.ID][]*Session)
	for i := range nodes {
...
type SessionGroupBy struct {
	query      *SessionQuery
	columns    []ent.EntityColumn[entity.Session]
	aggregates []ent.Selection
}

func (_g *SessionGroupBy) Aggregate(selections ...ent.Selection) *SessionGroupBy {
...
func (_g *SessionGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *SessionGroupBy) selectQuery() *SessionSelect {
...
type SessionSelect struct {
	...
	groups     []ent.EntityColumn[entity.Session]
}

func (_s *SessionSelect) Aggregate(selections ...ent.Selection) *SessionSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *SessionSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *SessionSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == session.Table) {
...
func (_s *SessionSelect) Scan(ctx context.Context, value any) error {
...
func (_s *SessionSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
