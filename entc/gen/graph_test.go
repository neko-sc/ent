...
func TestGraph_GenSemanticFields(t *testing.T) {
	...
	require.Contains(string(model), "Labels semantic.Labels")
	require.Contains(string(model), "new(*semantic.Labels)")
	require.Contains(string(model), ".(**semantic.Labels)")
	...
	require.Contains(string(meta), "ent.ArrayColumn[entity.User, string]")
	require.Contains(string(meta), "ent.ArrayColumn[entity.User, schema_types.RestrictionType]")
