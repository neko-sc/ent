...
import (
	...
	"github.com/neko-sc/ent/examples/rls/ent/migrate"
...
func (c *TenantClient) Create() *TenantCreate {
	...
	return &TenantCreate{config: c.config, mutation: mutation, fromBuilder: true}
}

func (c *TenantClient) Insert(value TenantInsert) *TenantCreate {
	mutation := newTenantMutation(c.config, OpCreate)
	mutation.insert = &value
	return &TenantCreate{config: c.config, mutation: mutation}
}

func (c *TenantClient) InsertBulk(values ...TenantInsert) *TenantCreateBulk {
	builders := make([]*TenantCreate, len(values))
...
func (c *TenantClient) Update() *TenantUpdate {
	...
	return &TenantUpdate{config: c.config, mutation: mutation}
}
...
func (c *TenantClient) UpdateOneID(id int) *TenantUpdateOne {
	...
	mutation.id = &id
	return &TenantUpdateOne{config: c.config, mutation: mutation}
}

// Delete returns a delete builder for Tenant.
func (c *TenantClient) Delete() *TenantDelete {
	mutation := newTenantMutation(c.config, OpDelete)
	return &TenantDelete{config: c.config, mutation: mutation}
}
...
func (c *TenantClient) DeleteOneID(id int) *TenantDeleteOne {
	builder := c.Delete().Where(tenant.ID.EQ(id))
...
func (c *TenantClient) Get(ctx context.Context, id int) (*Tenant, error) {
	return c.Query().Where(tenant.ID.EQ(id)).Only(ctx)
}
...
func (c *TenantClient) mutate(ctx context.Context, m *TenantMutation) (any, error) {
	switch m.Op() {
	case OpCreate:
		return (&TenantCreate{config: c.config, mutation: m}).Save(ctx)
	case OpUpdate:
		return (&TenantUpdate{config: c.config, mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&TenantUpdateOne{config: c.config, mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&TenantDelete{config: c.config, mutation: m}).Exec(ctx)
	default:
