...
func (b *UserUpdate) check() error {
	...
	if b.mutation.patch.TenantID.IsNull() {
		return &ValidationError{Name: "tenant_id", err: errors.New(`ent: field "User.tenant_id" is not nullable`)}
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.patch.TenantID.Get(); ok {
		_spec.SetField(user.FieldTenantID, field.TypeInt, value)
	}
	if value, ok := _u.mutation.patch.TenantIDAdd.Get(); ok {
