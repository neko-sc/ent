...
// Tenant, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *TenantQuery) WithCount[N, K any](edge ent.Relation[entity.Tenant, N, K], predicates ...ent.Predicate[N]) *TenantQuery {
