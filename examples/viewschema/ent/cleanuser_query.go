...
import (
	...
	"github.com/neko-sc/ent/examples/viewschema/ent/cleanuser"
...
// always included.
func (_q *CleanUserQuery) Columns(columns ...ent.EntityColumn[entity.CleanUser]) *CleanUserQuery {
	if len(columns) == 0 {
...
func (_q *CleanUserQuery) Modify(modifiers ...func(s *sql.Selector)) *CleanUserQuery {
