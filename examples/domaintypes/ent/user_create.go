...
func (b *UserCreate) check() error {
	...
	case dialect.Postgres, dialect.SQLite:
		if _, present := b.present[user.FieldPostalCode]; b.fromBuilder && !present {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec, error) {
	...
	if _, present := _c.present[user.FieldPostalCode]; !_c.fromBuilder || present {
		value := _c.mutation.insert.PostalCode
