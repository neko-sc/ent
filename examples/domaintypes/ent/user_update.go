...
import (
	...
	"github.com/neko-sc/ent/examples/domaintypes/ent/entity"
...
func (b *UserUpdate) check() error {
	...
	if b.mutation.patch.PostalCode.IsNull() {
		return &ValidationError{Name: "postal_code", err: errors.New(`ent: field "User.postal_code" is not nullable`)}
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.patch.PostalCode.Get(); ok {
