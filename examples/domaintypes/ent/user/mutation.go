...
import (
	...
	"github.com/neko-sc/ent/examples/domaintypes/ent/predicate"
)
...
func (m *Mutation) SetPostalCode(s string) {
	m.postal_code = &s
}

// PostalCode returns the value of the "postal_code" field in the mutation.
func (m *Mutation) PostalCode() (r string, exists bool) {
	v := m.postal_code
	if v == nil {
		return
	}
...
func (m *Mutation) ResetPostalCode() {
	m.postal_code = nil
}
