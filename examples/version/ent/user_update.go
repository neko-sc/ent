...
func (b *UserUpdate) check() error {
	...
	if b.mutation.patch.Version.IsNull() {
	...
	if b.mutation.patch.Status.IsNull() {
		return &ValidationError{Name: "status", err: errors.New(`ent: field "User.status" is not nullable`)}
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.patch.Version.Get(); ok {
		_spec.SetField(user.FieldVersion, field.TypeInt64, value)
	}
	if value, ok := _u.mutation.patch.VersionAdd.Get(); ok {
