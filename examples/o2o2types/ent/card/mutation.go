...
import (
	...
	"github.com/neko-sc/ent/examples/o2o2types/ent/predicate"
)
...
func (m *Mutation) SetExpired(t time.Time) {
	m.expired = &t
}

// Expired returns the value of the "expired" field in the mutation.
func (m *Mutation) Expired() (r time.Time, exists bool) {
	v := m.expired
	if v == nil {
		return
	}
...
func (m *Mutation) Fields() []string {
	...
	if m.expired != nil {
		fields = append(fields, FieldExpired)
	}
	if m.number != nil {
