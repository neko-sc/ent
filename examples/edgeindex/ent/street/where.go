...
func ID(id int) predicate.Street {
	return predicate.Street(sql.FieldEQ(FieldID, id))
}
...
func IDNEQ(id int) predicate.Street {
	return predicate.Street(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...int) predicate.Street {
	return predicate.Street(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...int) predicate.Street {
	return predicate.Street(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id int) predicate.Street {
	return predicate.Street(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id int) predicate.Street {
	return predicate.Street(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id int) predicate.Street {
	return predicate.Street(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id int) predicate.Street {
	return predicate.Street(sql.FieldLTE(FieldID, id))
}

// Name applies equality check predicate on the "name" field. It's identical to NameEQ.
func Name(v string) predicate.Street {
	return predicate.Street(sql.FieldEQ(FieldName, v))
}
...
func NameNEQ(v string) predicate.Street {
	return predicate.Street(sql.FieldNEQ(FieldName, v))
}

// NameIn applies the In predicate on the "name" field.
func NameIn(vs ...string) predicate.Street {
	return predicate.Street(sql.FieldIn(FieldName, vs...))
}

// NameNotIn applies the NotIn predicate on the "name" field.
func NameNotIn(vs ...string) predicate.Street {
	return predicate.Street(sql.FieldNotIn(FieldName, vs...))
}

// NameGT applies the GT predicate on the "name" field.
func NameGT(v string) predicate.Street {
	return predicate.Street(sql.FieldGT(FieldName, v))
}

// NameGTE applies the GTE predicate on the "name" field.
func NameGTE(v string) predicate.Street {
	return predicate.Street(sql.FieldGTE(FieldName, v))
}

// NameLT applies the LT predicate on the "name" field.
func NameLT(v string) predicate.Street {
	return predicate.Street(sql.FieldLT(FieldName, v))
}
...
func NameHasPrefix(v string) predicate.Street {
	return predicate.Street(sql.FieldHasPrefix(FieldName, v))
}
...
func And(predicates ...predicate.Street) predicate.Street {
	return predicate.Street(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.Street) predicate.Street {
	return predicate.Street(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.Street) predicate.Street {
	return predicate.Street(sql.NotPredicates(p))
}
