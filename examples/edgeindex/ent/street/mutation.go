...
// Mutation represents an operation that mutates the Street nodes in the graph.
...
// NewMutation creates a new Mutation for the Street entity.
...
func (m *Mutation) Predicates() []predicate.Street {
	return m.predicates
}
...
func (m *Mutation) SetCityID(id int) {
	m.city = &id
}

// ClearCity clears the "city" edge to the City entity.
func (m *Mutation) ClearCity() {
	m.clearedcity = true
}

// CityCleared reports if the "city" edge to the City entity was cleared.
func (m *Mutation) CityCleared() bool {
	return m.clearedcity
}

// CityID returns the "city" edge ID in the mutation.
func (m *Mutation) CityID() (id int, exists bool) {
	if m.city != nil {
		return *m.city, true
	}
	return
...
func (m *Mutation) CityIDs() (ids []int) {
	if id := m.city; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *Mutation) ResetCity() {
	m.city = nil
	m.clearedcity = false
}

// Where appends a list predicates to the Mutation builder.
func (m *Mutation) Where(ps ...predicate.Street) {
