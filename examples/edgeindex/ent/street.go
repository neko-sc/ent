...
func (e StreetEdges) Loaded[N, K any](edge ent.RelationOf[entity.Street, N, K]) bool {
...
func (e *StreetEdges) SetLoaded[N, K any](edge ent.RelationOf[entity.Street, N, K], loaded bool) {
	switch edge.Ref().Name {
	case "city":
...
func (e StreetEdges) Count[N, K any](edge ent.Relation[entity.Street, N, K]) (int, bool) {
