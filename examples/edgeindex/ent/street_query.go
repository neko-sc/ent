...
// Street, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *StreetQuery) WithCount[N, K any](edge ent.Relation[entity.Street, N, K], predicates ...ent.Predicate[N]) *StreetQuery {
...
// always included.
func (_q *StreetQuery) Columns(columns ...ent.EntityColumn[entity.Street]) *StreetQuery {
	if len(columns) == 0 {
