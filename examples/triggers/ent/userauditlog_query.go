...
func (_q *UserAuditLogQuery) Where(predicates ...ent.Predicate[entity.UserAuditLog]) *UserAuditLogQuery {
	_q.predicates = append(_q.predicates, predicates...)
	return _q
}

func (_q *UserAuditLogQuery) WhereP(predicates ...func(*sql.Selector)) *UserAuditLogQuery {
...
func (_q *UserAuditLogQuery) Join(table string, on ...func(*sql.Selector)) *UserAuditLogQuery {
	return _q.JoinAs(table, "", on...)
}

func (_q *UserAuditLogQuery) JoinAs(table, alias string, on ...func(*sql.Selector)) *UserAuditLogQuery {
...
func (_q *UserAuditLogQuery) LeftJoin(table string, on ...func(*sql.Selector)) *UserAuditLogQuery {
	return _q.LeftJoinAs(table, "", on...)
}

func (_q *UserAuditLogQuery) LeftJoinAs(table, alias string, on ...func(*sql.Selector)) *UserAuditLogQuery {
	on = append([]func(*sql.Selector){}, on...)
	_q.joins = append(_q.joins, func(selector *sql.Selector) {
		joined := sql.Dialect(selector.Dialect()).Table(table)
		if alias != "" {
...
func (_q *UserAuditLogQuery) Order(o ...ent.OrderOption[entity.UserAuditLog]) *UserAuditLogQuery {
...
// always included.
func (_q *UserAuditLogQuery) Columns(columns ...ent.EntityColumn[entity.UserAuditLog]) *UserAuditLogQuery {
	if len(columns) == 0 {
...
func (_q *UserAuditLogQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if ids, err = ent.Values(ctx, _q.Select(userauditlog.ID), userauditlog.ID); err != nil {
		return nil, err
	}
	return ids, nil
}
...
//		GroupBy(userauditlog.OperationType).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
func (_q *UserAuditLogQuery) GroupBy(columns ...ent.EntityColumn[entity.UserAuditLog]) *UserAuditLogGroupBy {
	if len(columns) == 0 {
		panic("ent: GroupBy requires at least one column")
	}
	return &UserAuditLogGroupBy{query: _q, columns: append([]ent.EntityColumn[entity.UserAuditLog](nil), columns...)}
}
...
//
//	client.UserAuditLog.Query().
//		Select(userauditlog.OperationType).
//		Scan(ctx, &v)
func (_q *UserAuditLogQuery) Select(selections ...ent.Selection) *UserAuditLogSelect {
	return &UserAuditLogSelect{query: _q, selections: append([]ent.Selection(nil), selections...)}
}

// Aggregate returns a UserAuditLogSelect configured with the given aggregations.
func (_q *UserAuditLogQuery) Aggregate(selections ...ent.Selection) *UserAuditLogSelect {
...
func (_q *UserAuditLogQuery) ForUpdate(opts ...sql.LockOption) *UserAuditLogQuery {
...
func (_q *UserAuditLogQuery) ForShare(opts ...sql.LockOption) *UserAuditLogQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *UserAuditLogQuery) Modify(modifiers ...func(s *sql.Selector)) *UserAuditLogSelect {
...
type UserAuditLogGroupBy struct {
	...
	columns    []ent.EntityColumn[entity.UserAuditLog]
	aggregates []ent.Selection
}

func (_g *UserAuditLogGroupBy) Aggregate(selections ...ent.Selection) *UserAuditLogGroupBy {
...
func (_g *UserAuditLogGroupBy) Rows(ctx context.Context) ([]*ent.Row, error) {
	return _g.selectQuery().Rows(ctx)
}

func (_g *UserAuditLogGroupBy) selectQuery() *UserAuditLogSelect {
...
type UserAuditLogSelect struct {
	...
	groups     []ent.EntityColumn[entity.UserAuditLog]
}

func (_s *UserAuditLogSelect) Aggregate(selections ...ent.Selection) *UserAuditLogSelect {
	_s.selections = append(_s.selections, selections...)
	return _s
}

func (_s *UserAuditLogSelect) Row(ctx context.Context) (*ent.Row, error) {
...
func (_s *UserAuditLogSelect) sqlQuery(ctx context.Context) (*sql.Selector, error) {
	root := _s.query.Clone()
	root.ctx.Fields = nil
	for _, selection := range _s.selections {
		if column := selection.Ref(); column.Name != "" && (column.Table == "" || column.Table == userauditlog.Table) {
...
func (_s *UserAuditLogSelect) Scan(ctx context.Context, value any) error {
...
func (_s *UserAuditLogSelect) Rows(ctx context.Context) ([]*ent.Row, error) {
	if len(_s.selections) == 0 {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *UserAuditLogSelect) Modify(modifiers ...func(s *sql.Selector)) *UserAuditLogSelect {
