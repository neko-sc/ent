...
func (m *Mutation) SetRegisteredAt(t time.Time) {
	m.registered_at = &t
}

// RegisteredAt returns the value of the "registered_at" field in the mutation.
func (m *Mutation) RegisteredAt() (r time.Time, exists bool) {
	v := m.registered_at
	if v == nil {
		return
	}
...
func (m *Mutation) ResetRegisteredAt() {
	m.registered_at = nil
}
...
func (m *Mutation) Fields() []string {
	...
	if m.registered_at != nil {
		fields = append(fields, FieldRegisteredAt)
	}
	return fields
}
