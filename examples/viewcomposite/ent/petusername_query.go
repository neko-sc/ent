...
// PetUserName, readable with Edges.Count. Only neighbors matching all predicates are
...
func (_q *PetUserNameQuery) WithCount[N, K any](edge ent.Relation[entity.PetUserName, N, K], predicates ...ent.Predicate[N]) *PetUserNameQuery {
...
// always included.
func (_q *PetUserNameQuery) Columns(columns ...ent.EntityColumn[entity.PetUserName]) *PetUserNameQuery {
	if len(columns) == 0 {
