...
func (m *Mutation) SetPublicInfo(s string) {
	m.public_info = &s
}

// PublicInfo returns the value of the "public_info" field in the mutation.
func (m *Mutation) PublicInfo() (r string, exists bool) {
	v := m.public_info
	if v == nil {
		return
	}
...
func (m *Mutation) ResetPublicInfo() {
	m.public_info = nil
}

// SetPrivateInfo sets the "private_info" field.
func (m *Mutation) SetPrivateInfo(s string) {
	m.private_info = &s
}

// PrivateInfo returns the value of the "private_info" field in the mutation.
func (m *Mutation) PrivateInfo() (r string, exists bool) {
	v := m.private_info
	if v == nil {
		return
	}
...
func (m *Mutation) ResetPrivateInfo() {
	m.private_info = nil
}
...
func (m *Mutation) Fields() []string {
	...
	if m.public_info != nil {
		fields = append(fields, FieldPublicInfo)
	}
	if m.private_info != nil {
		fields = append(fields, FieldPrivateInfo)
	}
	return fields
}
...
func (m *Mutation) Field(name string) (ent.Value, bool) {
	...
	case FieldName:
		return m.Name()
	case FieldPublicInfo:
		return m.PublicInfo()
	case FieldPrivateInfo:
